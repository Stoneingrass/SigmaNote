...
import com.sigmanote.notes.model.JsonManager.ImportResult
import com.sigmanote.notes.model.entity.BlankNoteMetadata
import com.sigmanote.notes.model.entity.Label
import com.sigmanote.notes.model.entity.LabelRef
import com.sigmanote.notes.model.entity.ListNoteMetadata
...
import com.sigmanote.notesshared.dateFor
import com.sigmanote.notesshared.testNote
...
class DefaultJsonManagerTest {
    ...
    private lateinit var database: com.sigmanote.notes.model.NotesDatabase
    private lateinit var notesDao: com.sigmanote.notes.model.NotesDao
    private lateinit var labelsDao: com.sigmanote.notes.model.LabelsDao

    private lateinit var prefsManager: com.sigmanote.notes.model.PrefsManager
    private lateinit var jsonManager: com.sigmanote.notes.model.JsonManager
    ...
    fun createDatabase() {
        ...
        database = Room.inMemoryDatabaseBuilder(context, com.sigmanote.notes.model.NotesDatabase::class.java).build()
        ...
        jsonManager = com.sigmanote.notes.model.DefaultJsonManager(notesDao, labelsDao, Json {
    ...
    fun testUnencryptedJsonExport() = runBlocking {
        ...
        notesDao.insert(Note(id = 1,
            ...
            reminder = Reminder(
                dateFor("2020-03-01"), Recurrence(Recurrence.Period.DAILY),
